...
plugins=(
	...
	zsh-autosuggestions \
  # zsh autocomplete using substring search \
...
# Ctrl+Right / Ctrl+Left (common GNOME Terminal sequences)
bindkey '^[[1;5C' forward-word
bindkey '^[[1;5D' backward-word

# History search by arrows
bindkey '^[[A' history-substring-search-up
bindkey '^[[B' history-substring-search-down

# enable starship (after oh-my-zsh so it takes over the prompt)
